...
function main()
    ...
    for it = 1:Nt
        ...
        ttemp = CUDA.@elapsed begin
                ...
                if save && (it%save_frequency == 0)
                    ...
                    save_object(saved_filename*"-lift_time_history-"*format_it*".jld2" , Array(lift_time_history))
                    save_object(saved_filename*"-drag_time_history-"*format_it*".jld2" , Array(drag_time_history))
                    print("Saved!\n")
                end
    ...
    if save
        ...
        save_object(saved_filename*"-lift_time_history-endwrite.jld2" , Array(lift_time_history))
        save_object(saved_filename*"-drag_time_history-endwrite.jld2" , Array(drag_time_history))
        print("Saved!\n")
    end
